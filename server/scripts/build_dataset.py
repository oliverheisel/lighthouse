...
def main():
    ...
    for el in data.get("elements", []):
        ...
        rows.append({
            ...
            "color": (tags.get("seamark:light:1:colour") or tags.get("seamark:light:colour") or "").lower(),
            "sequence": tags.get("seamark:light:1:sequence") or tags.get("seamark:light:sequence") or "",
        })
    ...
    payload = json.dumps(df.to_dict(orient="records"), ensure_ascii=False, separators=(",", ":"))
